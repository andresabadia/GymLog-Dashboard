        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="d-flex justify-content-end social_icon">
              <span><img class="gymlog-logo" alt="GymLog logo" src="../assets/logo.png"></span>
            </div>
          </div>
          <div class="card-body">
          ...
          <div class="card-footer">
            <div class="d-flex justify-content-center links">
              <span>Tenés problemas conectándote? Contactá al <nobr><i class="fab fa-whatsapp"></i> 8778 6917</nobr></span>
            </div>
          </div>
        </div>
      </div>
